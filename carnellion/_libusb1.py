...
class libusb_codes:
    def __init__(self):
        ...
        enums = [libusb_transfer_flags,libusb_transfer_status,libusb_error,libusb_supported_speed,libusb_speed,libusb_iso_usage_type,libusb_class_code,libusb_request_type,libusb_request_recipient,libusb_descriptor_type]
        for i in enums:
            for att in i.forward_dict:
                setattr(self,att,i.forward_dict[att])
libc = libusb_codes()
